...
15. click on debug and simulate .
...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,0);
  Lcd_string(&lcd, "PRAVEEN K\n");
  Lcd_cursor(&lcd, 1,2);
  Lcd_string(&lcd, "212223040152");
  HAL_Delay(500);
...
![WhatsApp Image 2024-03-30 at 21 38 36_ab7dde39](https://github.com/praveen2p/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/151658061/5744e3f9-f62b-49d0-bec7-90055c1151cd)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 ![WhatsApp Image 2024-03-30 at 21 38 35_d778c275](https://github.com/praveen2p/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/151658061/024e5667-06f5-45d0-9293-f256d2935225)
